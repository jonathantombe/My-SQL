...
ALTER TABLE asignatura ADD CONSTRAINT fk_asignatura_grado
FOREIGN KEY (cod_grado) REFERENCES grado(id_grado);

ALTER TABLE alumno_se_matricula_asignatura ADD CONSTRAINT fk_matricula_alumno
FOREIGN KEY (id_alumno) REFERENCES alumno(id);

ALTER TABLE alumno_se_matricula_asignatura ADD CONSTRAINT fk_matricula_asignatura
FOREIGN KEY (cod_asignatura) REFERENCES asignatura(id_asignatura);

ALTER TABLE alumno_se_matricula_asignatura ADD CONSTRAINT fk_matricula_curso_escolar
FOREIGN KEY (cod_escolar) REFERENCES curso_escolar(id_escolar);
